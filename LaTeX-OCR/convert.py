...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='/home/ivsr/CV_Group/minh/LaTeX-OCR/settings/config.yaml')
    parser.add_argument('-m', '--checkpoint', type=str, default='/home/ivsr/CV_Group/minh/LaTeX-OCR/checkpoints/weights.pth')
